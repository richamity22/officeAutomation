...
public class TeamsHelperImpl extends PageBase implements TeamsHelper{
    ...
    public void login(String userName, String password) {
        ...
        webDriver.get("https://teams.microsoft.com/_#/my/file-personal");
        //Use Web App
        webDriver.manage().window().maximize();
        String xpathWebApp = "//*[text()='Use the web app instead']";
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpathWebApp)));
        WebElement weWebApp = webDriver.findElement(By.xpath(xpathWebApp));
        act.moveToElement(weWebApp).click().build().perform();
        String xpathClosePop = "//button[@title='Close']";
        List<WebElement> weClosePops = webDriver.findElements(By.xpath(xpathClosePop));
        for (WebElement weClosePop: weClosePops){
            act.moveToElement(weClosePop).click().build().perform();
        }
    ...
    public void createNew(String name, String type){
        ...
        if ( existingNames.size() == 1 ){
            ...
            if (type.equals("Folder")){
                String xpathInputName="//*[contains(@placeholder,'folder name')]";
                ...
                String xpathCreateButton="//button//*[text()='Create']";
