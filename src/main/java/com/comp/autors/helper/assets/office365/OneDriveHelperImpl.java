...
public class OneDriveHelperImpl  extends PageBase implements OneDriveHelper{
    ...
    // Need to move to base functionality later
    ...
    @Override
    public void createFolder(String newFolderPathName) {
        String folderName = CommonUtils.getContainingObject(newFolderPathName);
        String path=CommonUtils.getContainingPath(newFolderPathName,folderName);
        navigateTo(path);
